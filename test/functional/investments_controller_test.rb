...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { funding_id: @investment.funding_id, investor_id: @investment.investor_id, investor_perma: @investment.investor_perma }
    end
  ...
  test "should update investment" do
    put :update, id: @investment, investment: { funding_id: @investment.funding_id, investor_id: @investment.investor_id, investor_perma: @investment.investor_perma }
    assert_redirected_to investment_path(assigns(:investment))
  end
